...
module.exports = {
	...
	module: {
		loaders: [
			{
				test: /\.css$/,
				use: ['style-loader', 'css-loader'], // 文件使用 style-loader、css-loader来编译处理
			},
			{
				test: /\.(png|jpg|jpeg|gif)(\?v=\d+\.\d+\.\d+)?$/i,//图片文件使用 url-loader 来处理，小于40000字节的直接转为base64
				use: 'url-loader?limit=10192'
			},
			{
				test: /\.(eot|ttf|svg)/, 
			...
			{
				test: /\.woff/, 
				use: 'file-loader?prefix=font/&limit=10000&mimetype=application/font-woff'
			},
			{
				test: /\.(js|jsx)$/,
				use: 'babel-loader',
